...
var AdminConnection_exports = {};
__export(AdminConnection_exports, {
  AdminConnection: () => AdminConnection
});
module.exports = __toCommonJS(AdminConnection_exports);
...
__name(parseIPAddresses, "parseIPAddresses");
class AdminConnection extends import_Connection.Connection {
  static {
    __name(this, "AdminConnection");
  }
  constructor(props) {
    super(props);
  }
   ...
   */
  cmdExec(host, cmd, cmdId, cmdTimeout, files) {
    return this.request({
      commandTimeout: cmdTimeout,
      executor: /* @__PURE__ */ __name((resolve, reject, timeout) => {
        host = (0, import_tools.normalizeHostId)(host);
  ...
  getDiagData(host, typeOfDiag) {
    host = (0, import_tools.objectIdToHostname)(host);
    return this.request({
      executor: /* @__PURE__ */ __name((resolve, _reject, timeout) => {
  ...
  getCurrentSession(cmdTimeout) {
    ...
    return this.request({
      ...
      executor: /* @__PURE__ */ __name(async (resolve, reject, timeout) => {
        try {
