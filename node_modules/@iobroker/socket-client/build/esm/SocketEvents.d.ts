...
export interface IOListenEvents {
    ...
    im: (messageType: string, from: string, data: any) => void;
    ...
    permissionError: (error: any) => void;
}
...
export type SubscribeOnInstanceCallback = (error: string | null, result?: {
    error?: string;
    accepted?: boolean;
    heartbeat?: number;
}) => void;
export type UnsubscribeFromInstanceCallback = (err: string | null, wasSubscribed: boolean) => void;
export type ErrorAsString<T extends (...args: any[]) => void> = T extends (err: Error | null, ...args: infer U) => void ? (err: string | null | undefined, ...args: U) => void : T extends (err?: Error | null, ...args: infer U) => void ? (err: string | null | undefined, ...args: U) => void : never;
...
export interface IOEmitEvents {
    ...
    getObjectView<Design extends string = string, Search extends string = string>(design: Design, search: Search, params: ioBroker.GetObjectViewParams | null | undefined, callback: ErrorAsString<ioBroker.GetObjectViewCallback<ioBroker.InferGetObjectViewItemType<Design, Search>>>): void;
    delObject: ((id: string, options: DelObjectOptions, callback?: ErrorAsString<ioBroker.GetObjectsCallback>) => void) | ((id: string, callback?: ErrorAsString<ioBroker.GetObjectsCallback>) => void);
    delObjects: ((id: string, options: DelObjectsOptions, callback?: ErrorAsString<ioBroker.GetObjectsCallback>) => void) | ((id: string, callback?: ErrorAsString<ioBroker.GetObjectsCallback>) => void);
    setObject(id: string, val: ioBroker.SettableObject, callback?: ErrorCallback): void;
    extendObject(id: string, objPart: ioBroker.PartialObject, callback?: ErrorAsString<ioBroker.SetObjectCallback>): void;
    getObject(id: string, callback?: ErrorAsString<ioBroker.GetObjectCallback>): void;
    getForeignObjects: ((pattern: string, type: ioBroker.ObjectType, callback: ErrorAsString<ioBroker.GetObjectsCallback>) => void) | ((pattern: string, callback: ErrorAsString<ioBroker.GetObjectsCallback>) => void);
    getStates(pattern?: string | string[], callback?: ErrorAsString<ioBroker.GetStatesCallback>): void;
    getForeignStates(pattern: string | string[] | null | undefined, callback?: ErrorAsString<ioBroker.GetStatesCallback>): void;
    ...
    setState(id: string, val: ioBroker.State | ioBroker.StateValue | ioBroker.SettableState, callback?: ErrorCallback): void;
    ...
    getHistory(id: string, options: ioBroker.GetHistoryOptions, callback: ErrorAsString<ioBroker.GetHistoryCallback>): void;
    ...
    clientSubscribe(targetInstance: string, messageType: string, data: any, callback?: SubscribeOnInstanceCallback): void;
...
export interface AdminEmitEvents {
    ...
    chmodFile(adapter: string | null, path: string, options?: {
        mode: number | string;
    }, callback?: ErrorAsString<ioBroker.ChownFileCallback>): void;
    chownFile(adapter: string | null, path: string, options?: {
        owner?: string;
        ownerGroup?: string;
    }, callback?: ErrorAsString<ioBroker.ChownFileCallback>): void;
    restartController(host: string, callback?: (result: '') => void): void;
    getIsEasyModeStrict(callback: GenericCallback<boolean>): void;
    getEasyMode(callback: GenericCallback<{
        strict: boolean;
        configs: any[];
    }>): void;
    ...
    getAdapterInstances(adapterName: string | null | undefined, callback: GenericCallback<ioBroker.InstanceObject[]>): void;
