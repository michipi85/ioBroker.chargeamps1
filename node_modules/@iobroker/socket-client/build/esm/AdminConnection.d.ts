import { Connection, type CommandFile, type RequestOptions } from './Connection.js';
...
export interface HostInfo {
    ...
    Platform: 'aix' | 'android' | 'darwin' | 'freebsd' | 'haiku' | 'linux' | 'openbsd' | 'sunos' | 'win32' | 'cygwin' | 'netbsd' | 'docker' | 'Windows' | 'OSX';
    /** The underlying OS */
...
export type AdapterRatingInfo = AdapterRating & {
    title: string;
};
...
export type InstalledInfo = {
    [adapterName: string]: AdapterInformationEx;
} & {
    hosts?: {
        [hostName: string]: ioBroker.HostCommon & {
            host: string;
            runningVersion: string;
        };
    };
...
export declare class AdminConnection extends Connection<AdminListenEvents, AdminEmitEvents> {
    ...
    getRepository(host: string, args?: {
        update?: boolean;
        repo?: string | string[];
    } | string | null, update?: boolean, timeoutMs?: number): Promise<Repository>;
    /**
     * Get the installed.
     *
     * @param host The host name.
    ...
    files?: CommandFile[]): Promise<void>;
    /**
     ...
     */
    getDiagData(host: string, typeOfDiag: 'none' | 'normal' | 'no-city' | 'extended'): Promise<Record<string, any> | null>;
    /**
