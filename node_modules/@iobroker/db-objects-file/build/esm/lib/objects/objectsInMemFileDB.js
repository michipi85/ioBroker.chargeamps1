        ...
        for (const file of _files) {
            ...
            if (fs.existsSync(path.join(location, file))) {
                try {
                    ...
                    const acl = this.fileOptions[id][name + file] && this.fileOptions[id][name + file].acl
                    ...
                    this.log.error(`${this.namespace} Cannot read permissions of ${path.join(this.objectsDir, id, name, file)}: ${e.message}`);
                }
            }
        }
        return res;
