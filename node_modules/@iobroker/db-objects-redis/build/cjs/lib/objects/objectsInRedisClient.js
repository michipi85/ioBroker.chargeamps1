...
class ObjectsInRedisClient {
      ...
      for (let i = 0; i < keys2.length; i++) {
        ...
        if (!obj.acl) {
          obj.acl = {
            ...
            object: this.defaultNewAcl?.object || CONSTS.ACCESS_USER_RW | CONSTS.ACCESS_GROUP_READ | CONSTS.ACCESS_EVERY_READ
            // '0644'
          };
          if (obj.type === "state") {
  ...
  async _getObjects(keys2, options2, callback, dontModify) {
    ...
    try {
      ...
      if (this.settings.connection.enhancedLogging) {
        this.log.silly(`${this.namespace} redis mget ${!objs2 ? 0 : objs2.length} ${_keys.length}`);
      }
    } catch (e) {
