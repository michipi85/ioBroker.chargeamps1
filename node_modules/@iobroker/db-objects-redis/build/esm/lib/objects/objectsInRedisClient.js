...
export class ObjectsInRedisClient {
    ...
    async _readDir(id, name, options, callback) {
        ...
        const result = [];
        const dontCheck = options.user === CONSTS.SYSTEM_ADMIN_USER ||
        ...
        if (oldObj?.common) {
            for (const commonSetting of this.preserveSettings) {
                ...
                if (commonSetting === 'custom') {
                    ...
                    if (oldObj.common.custom !== undefined &&
    ...
    async _getObjectList(params, options) {
        if (!this.client) {
            throw new Error(ERRORS.ERROR_DB_CLOSED);
        }
        params = params || {};
    ...
    extendObject(id, obj, options, callback) {
        ...
        if (!callback) {
            return new Promise((resolve, reject) => this.extendObject(id, obj, options, (err, res) => (err ? reject(err) : resolve(res))));
        }
        if (options?.acl) {
            options.acl = null;
        }
