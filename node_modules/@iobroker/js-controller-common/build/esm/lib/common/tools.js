...
import { SUPPORTED_FEATURES } from './constants.js';
/**
 ...
 */
export async function getInstancesOrderedByStartPrio(objects, logger, logPrefix = '') {
    ...
    if (!doc.rows || doc.rows.length === 0) {
        ...
        for (const row of doc.rows) {
            if (row?.value) {
                ...
                else if (row.value.common?.tier !== undefined &&
 ...
 */
export function isInstalledFromNpm(options) {
