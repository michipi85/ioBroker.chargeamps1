import { exec, execRaw, execute, finalizeRollback, isReleaseError, ReleaseError, resolvePlugins, stripColors, } from "@alcalzone/release-script-core";
...
export async function main() {
    ...
    let argv = yargsInstance
        ...
        noRollback: {
            type: "boolean",
            description: "Do not roll back local changes (file edits, commits, tags) if the release fails before pushing",
            default: false,
        },
    });
    ...
    try {
        ...
        console.error(prependPrefix(context.cli.prefix, colorizeTextAndTags(`[FATAL] Rollback itself failed: ${msg}`, colors.red, colors.bgRed)));
